...
from dataflows.vnstock_fundamentals import (
...
def get_balance_sheet(
    ...
    """
    return _get_balance_sheet(ticker, freq)
...
def get_cashflow(
    ...
    """
    return _get_cashflow(ticker, freq)
...
def get_income_statement(
    ...
    """
    return _get_income_statement(ticker, freq)